...
const form = useForm({
    ...
    thumbnails: props.post.thumbnails,
});
...
const uploadThumbnail = async (e) => {
    ...
    data.append('oldThumbnail', form.thumbnails); // kirim thumbnail lama
...
const submit = () => {
    const updateData = {
        ...
        thumbnails: form.thumbnails !== props.post.thumbnails ? form.thumbnails : null,
    };

    form.put(`/posts/${props.post.id}`, {
        data: updateData,
        onSuccess: () => Swal.fire('Sukses', 'Data berhasil diupdate', 'success'),
        onError: () => Swal.fire('Gagal', 'Periksa kembali input Anda.', 'error'),
    });
};
